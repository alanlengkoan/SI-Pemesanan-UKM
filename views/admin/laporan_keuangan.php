...
$koneksi = new mysqli("localhost", "root", "", "ukmdesatritiro");
?>
<html>
<head>
...
<body>
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
        ...
        $query = "SELECT * FROM transaksi penjualan BY tgl"; // Tampilkan semua data transaksi diurutkan berdasarkan tanggal
    }
    ?>
