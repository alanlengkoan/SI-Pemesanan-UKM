...
<head>
    ...
    <link rel="shortcut icon" href="images/ico/bulkum.ico">
                ...
                <div class="col-md-40">
                    <div class="thumbnail">
                        <div class="caption">
                            ...
                            <h5><img src="pictures/foto_berita/<?php echo $result['foto']; ?>"></h5>
                        </div>
                    </div>
                </div>
                <a href="berita.php" class="btn btn-primary">Kembali</a>
            </div>
        </div>
    </section>
